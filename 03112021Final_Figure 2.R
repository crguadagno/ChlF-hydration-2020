...
data<-read.csv(file="/Users/Lina/Desktop/ML/Photosynthetica 2020/DoubleError_Fm'_RChlF_All.csv")
...
mylabel = bquote(italic(R) == .(format(0.6485772  , digits = 3)))
...
mylabel = bquote(italic(R) == .(format(0.8812284, digits =3 )))
